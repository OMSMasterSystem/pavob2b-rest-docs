...
| `discount_rate`        | number                 | The discount rate of the order, supplied as a number between `0` and `1`. <i class="label label-info">read-only</i>                                               |
...
| `tax_rate`             | number                 | The tax rate of the order, supplied as a number between `0` and `1`. <i class="label label-info">read-only</i>                                                    |
